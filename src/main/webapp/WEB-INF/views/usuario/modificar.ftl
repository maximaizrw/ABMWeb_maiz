...
<div class="container mt-5">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Modificar Información del Usuario</h5>
            <div class="error"></div>
            <form action="${context_path}/usuario/procesarModificacion/${usuario.id}" method="POST"
                class="form-modificar-usuario needs-validation" data-remote="true" novalidate>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="apellido" name="apellido"
                            value="${usuario.apellido}" required pattern="[A-Za-z]{4,}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="alias" name="alias" value="${usuario.alias}"
                            required pattern="^(?=.*[A-Za-z].*[A-Za-z].*[A-Za-z].*[A-Za-z].*[A-Za-z])(?=.*\d.*\d).*$">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control" id="email_principal" name="email_principal"
                            value="${usuario.email_principal}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control" id="email_secundario" name="email_secundario"
                            value="${usuario.email_secundario}">
                        <div class="invalid-feedback">Por favor, ingresa un correo electrónico válido</div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="nro_celular">Número de Celular:</label>
                        <input type="tel" class="form-control" id="nro_celular" name="nro_celular"
                            value="${usuario.nro_celular}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="tipo_usuario_id">Tipo de Usuario:</label>
                        <select class="form-select" id="tipo_usuario_id" name="tipo_usuario_id"
                            value="${usuario.tipoUsuario.descripcion}" required>
